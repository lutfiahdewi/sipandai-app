    ...
    <Transition name="modal">
      <div v-if="showModal" class="modal-mask">
        <div class="modal-container rounded-lg w-[600px] border bg-slate-200 " :class="classModal" v-on-click-outside="close">
          <!-- Header section -->
          <div class="modal-header bg-orange-400 border-b rounded-t-lg px-5 py-3" :class="classHeader">
          ...
          <!-- Body section -->
          <div class="modal-body bg-slate-50 px-5 py-6 overflow-y-scroll max-h-64" :class="classBody">
            <slot name="body">
          ...
          <!-- Footer section -->
          <div class="modal-footer px-5 py-3 border-t rounded-b-lg " :class="classFooter">
            <slot name="footer">
