...
const tableName = "subcategories3";
const columns = [
  {
    label: "Name",
    field: "name",
  ...
  {
    label: "Kategori",
    field: "subcategories2.subcategories1.categories.name",
    thClass: "hidden sm:table-cell",
    tdClass: "hidden sm:table-cell",
  },
  {
    label: "Sub Kategori 1",
    field: "subcategories2.subcategories1.name",
    thClass: "hidden sm:table-cell",
    tdClass: "hidden sm:table-cell",
  },
  {
...
const getData = async () =>
  useGetAllData(
    ...
    loadingData,
    supabase,
    `id, name, subcategories2 (name, subcategories1!inner(name, categories!inner(name)))`
  );
